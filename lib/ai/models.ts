...
export const ROUTERAI_PAID_MODEL_IDS = ["deepseek/deepseek-v3.2"] as const;
...
export const aiModelOptions = [
  ...
  {
    id: OPENROUTER_FREE_MODEL_IDS[3],
    label: "Trinity Large",
    description: "OpenRouter | Free | Longer answers in the free tier.",
  },
] as const;
