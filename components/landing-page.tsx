        ...
        <header className="mx-auto w-full max-w-5xl">
          <div className="flex items-center justify-between gap-4 rounded-full border border-white/65 bg-white/20 px-4 py-3 shadow-[0_18px_40px_rgba(24,33,29,0.05)] backdrop-blur-md">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <Link
                href={secondaryHref}
                className="rounded-full border px-4 py-2 text-sm font-medium text-white transition-all duration-300 hover:-translate-y-0.5"
                style={{
                  borderColor: "rgba(50, 152, 140, 0.38)",
                  backgroundColor: "rgba(50, 152, 140, 0.78)",
                  boxShadow: "0 12px 28px rgba(50, 152, 140, 0.18)",
                }}
              >
                {secondaryLabel}
              </Link>
        ...
        <section className="flex flex-1 items-center justify-center">
          <div className="w-full max-w-4xl rounded-[2.6rem] border border-white/55 bg-transparent px-6 py-10 text-center shadow-[0_25px_60px_rgba(45,78,138,0.08)] backdrop-blur-[10px] sm:px-10 sm:py-14">
            ...
            <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
              ...
              <Link
                href={secondaryHref}
                className="rounded-full border px-8 py-3.5 text-base font-medium text-white transition-all duration-300 hover:-translate-y-1"
                style={{
                  borderColor: "rgba(50, 152, 140, 0.36)",
                  backgroundColor: "rgba(50, 152, 140, 0.82)",
                  boxShadow: "0 16px 34px rgba(50, 152, 140, 0.16)",
                }}
              >
                {secondaryLabel}
              </Link>
